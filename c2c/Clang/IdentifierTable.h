...
/// DenseSets.
template <>
struct DenseMapInfo<c2lang::Selector> {
  static c2lang::Selector getEmptyKey() {
    return c2lang::Selector::getEmptyMarker();
  }

  static c2lang::Selector getTombstoneKey() {
    return c2lang::Selector::getTombstoneMarker();
  }

  static unsigned getHashValue(c2lang::Selector S);

  static bool isEqual(c2lang::Selector LHS, c2lang::Selector RHS) {
    return LHS == RHS;
  }
};

template <>
struct isPodLike<c2lang::Selector> { static const bool value = true; };

template<>
struct PointerLikeTypeTraits<c2lang::Selector> {
  static const void *getAsVoidPointer(c2lang::Selector P) {
    return P.getAsOpaquePtr();
  }

  static c2lang::Selector getFromVoidPointer(const void *P) {
    return c2lang::Selector(reinterpret_cast<uintptr_t>(P));
  }
