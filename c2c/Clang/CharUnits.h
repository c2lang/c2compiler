...
inline c2lang::CharUnits operator* (c2lang::CharUnits::QuantityType Scale,
                                   const c2lang::CharUnits &CU) {
  return CU * Scale;
}

namespace llvm {

template<> struct DenseMapInfo<c2lang::CharUnits> {
  static c2lang::CharUnits getEmptyKey() {
    c2lang::CharUnits::QuantityType Quantity =
      DenseMapInfo<c2lang::CharUnits::QuantityType>::getEmptyKey();

    return c2lang::CharUnits::fromQuantity(Quantity);
  }

  static c2lang::CharUnits getTombstoneKey() {
    c2lang::CharUnits::QuantityType Quantity =
      DenseMapInfo<c2lang::CharUnits::QuantityType>::getTombstoneKey();

    return c2lang::CharUnits::fromQuantity(Quantity);
  }

  static unsigned getHashValue(const c2lang::CharUnits &CU) {
    c2lang::CharUnits::QuantityType Quantity = CU.getQuantity();
    return DenseMapInfo<c2lang::CharUnits::QuantityType>::getHashValue(Quantity);
  }

  static bool isEqual(const c2lang::CharUnits &LHS,
                      const c2lang::CharUnits &RHS) {
    return LHS == RHS;
  }
};

template <> struct isPodLike<c2lang::CharUnits> {
