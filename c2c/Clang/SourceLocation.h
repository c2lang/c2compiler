...
//
/// \file
/// Defines the c2lang::SourceLocation class and associated facilities.
//
//===----------------------------------------------------------------------===//
...
namespace llvm {
  ...
  /// DenseSets.
  template <>
  struct DenseMapInfo<c2lang::FileID> {
    static c2lang::FileID getEmptyKey() {
      return {};
    }

    static c2lang::FileID getTombstoneKey() {
      return c2lang::FileID::getSentinel();
    }

    static unsigned getHashValue(c2lang::FileID S) {
      return S.getHashValue();
    }

    static bool isEqual(c2lang::FileID LHS, c2lang::FileID RHS) {
      return LHS == RHS;
    }
  };

  template <>
  struct isPodLike<c2lang::SourceLocation> { static const bool value = true; };
  template <>
  struct isPodLike<c2lang::FileID> { static const bool value = true; };

  // Teach SmallPtrSet how to handle SourceLocation.
  template<>
  struct PointerLikeTypeTraits<c2lang::SourceLocation> {
    enum { NumLowBitsAvailable = 0 };

    static void *getAsVoidPointer(c2lang::SourceLocation L) {
      return L.getPtrEncoding();
    }

    static c2lang::SourceLocation getFromVoidPointer(void *P) {
      return c2lang::SourceLocation::getFromRawEncoding((unsigned)(uintptr_t)P);
    }
  };
