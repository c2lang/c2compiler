...
void Preprocessor::Handle_Pragma(Token &Tok) {
  ...
  //     INACTIVE(_Pragma("c2lang diagnostic ignored \"-Wconversion\""))
...
void Preprocessor::HandlePragmaModuleBuild(Token &Tok) {
  ...
  while (true) {
    ...
    CurLexer->Lex(Tok);
    if (TryConsumeIdentifier("pragma") && TryConsumeIdentifier("c2lang") &&
        TryConsumeIdentifier("module")) {
      if (TryConsumeIdentifier("build"))
        // #pragma c2lang module build -> entering a nested module build.
        ++NestingLevel;
      else if (TryConsumeIdentifier("endbuild")) {
        // #pragma c2lang module endbuild -> leaving a module build.
        if (--NestingLevel == 0)
          break;
      }
...
struct PragmaDebugHandler : public PragmaHandler {
  ...
  void HandlePragma(Preprocessor &PP, PragmaIntroducerKind Introducer,
    ...
    if (II->isStr("assert")) {
      ...
      llvm::report_fatal_error("#pragma c2lang __debug llvm_fatal_error");
    } else if (II->isStr("llvm_unreachable")) {
      llvm_unreachable("#pragma c2lang __debug llvm_unreachable");
  ...
  void HandleCaptured(Preprocessor &PP) {
    ...
    if (Tok.isNot(tok::eod)) {
      PP.Diag(Tok, diag::ext_pp_extra_tokens_at_eol)
        << "pragma c2lang __debug captured";
      return;
    }
...
public:
  ...
  void HandlePragma(Preprocessor &PP, PragmaIntroducerKind Introducer,
    ...
    if (Group == "everything") {
      // Special handling for pragma c2lang diagnostic ... "-Weverything".
...
/// "\#pragma warning(...)".  MSVC's diagnostics do not map cleanly to c2lang's
...
/// Handle the c2lang \#pragma module import extension. The syntax is:
/// \code
///   #pragma c2lang module import some.module.name
/// \endcode
...
/// Handle the c2lang \#pragma module begin extension. The syntax is:
/// \code
///   #pragma c2lang module begin some.module.name
///   ...
///   #pragma c2lang module end
/// \endcode
...
/// Handle the c2lang \#pragma module end extension.
...
/// Handle the c2lang \#pragma module build extension.
...
/// Handle the c2lang \#pragma module load extension.
...
///   \#pragma c2lang arc_cf_code_audited begin/end
...
///   \#pragma c2lang assume_nonnull begin/end
...
void Preprocessor::RegisterBuiltinPragmas() {
  ...
  AddPragmaHandler("GCC", new PragmaMessageHandler(PPCallbacks::PMK_Error,
                                                   "GCC"));
  // #pragma c2lang ...
  AddPragmaHandler("c2lang", new PragmaPoisonHandler());
  AddPragmaHandler("c2lang", new PragmaSystemHeaderHandler());
  AddPragmaHandler("c2lang", new PragmaDebugHandler());
  AddPragmaHandler("c2lang", new PragmaDependencyHandler());
  AddPragmaHandler("c2lang", new PragmaDiagnosticHandler("c2lang"));
  AddPragmaHandler("c2lang", new PragmaARCCFCodeAuditedHandler());
  AddPragmaHandler("c2lang", new PragmaAssumeNonNullHandler());

  // #pragma c2lang module ...
  auto *ModuleHandler = new PragmaNamespace("module");
  AddPragmaHandler("c2lang", ModuleHandler);
...
void Preprocessor::IgnorePragmas() {
  ...
  AddPragmaHandler("c2lang", new EmptyPragmaHandler());
}
