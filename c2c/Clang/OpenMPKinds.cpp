...
OpenMPDirectiveKind c2lang::getOpenMPDirectiveKind(StringRef Str) {
  return llvm::StringSwitch<OpenMPDirectiveKind>(Str)
#define OPENMP_DIRECTIVE(Name) .Case(#Name, OMPD_##Name)
#define OPENMP_DIRECTIVE_EXT(Name, Str) .Case(Str, OMPD_##Name)
#include "Clang//OpenMPKinds.def"
      .Default(OMPD_unknown);
}

const char *c2lang::getOpenMPDirectiveName(OpenMPDirectiveKind Kind) {
...
OpenMPClauseKind c2lang::getOpenMPClauseKind(StringRef Str) {
...
const char *c2lang::getOpenMPClauseName(OpenMPClauseKind Kind) {
...
unsigned c2lang::getOpenMPSimpleClauseType(OpenMPClauseKind Kind,
                                          StringRef Str) {
  switch (Kind) {
  case OMPC_default:
...
const char *c2lang::getOpenMPSimpleClauseTypeName(OpenMPClauseKind Kind,
                                                 unsigned Type) {
  switch (Kind) {
  case OMPC_default:
    switch (Type) {
...
bool c2lang::isAllowedClauseForDirective(OpenMPDirectiveKind DKind,
...
bool c2lang::isOpenMPLoopDirective(OpenMPDirectiveKind DKind) {
...
bool c2lang::isOpenMPWorksharingDirective(OpenMPDirectiveKind DKind) {
...
bool c2lang::isOpenMPTaskLoopDirective(OpenMPDirectiveKind DKind) {
  return DKind == OMPD_taskloop || DKind == OMPD_taskloop_simd;
}

bool c2lang::isOpenMPParallelDirective(OpenMPDirectiveKind DKind) {
...
bool c2lang::isOpenMPTargetExecutionDirective(OpenMPDirectiveKind DKind) {
...
bool c2lang::isOpenMPTargetDataManagementDirective(OpenMPDirectiveKind DKind) {
  return DKind == OMPD_target_data || DKind == OMPD_target_enter_data ||
         DKind == OMPD_target_exit_data || DKind == OMPD_target_update;
}

bool c2lang::isOpenMPNestingTeamsDirective(OpenMPDirectiveKind DKind) {
...
bool c2lang::isOpenMPTeamsDirective(OpenMPDirectiveKind DKind) {
...
bool c2lang::isOpenMPSimdDirective(OpenMPDirectiveKind DKind) {
...
bool c2lang::isOpenMPNestingDistributeDirective(OpenMPDirectiveKind Kind) {
...
bool c2lang::isOpenMPDistributeDirective(OpenMPDirectiveKind Kind) {
...
bool c2lang::isOpenMPPrivate(OpenMPClauseKind Kind) {
...
bool c2lang::isOpenMPThreadPrivate(OpenMPClauseKind Kind) {
  return Kind == OMPC_threadprivate || Kind == OMPC_copyin;
}

bool c2lang::isOpenMPTaskingDirective(OpenMPDirectiveKind Kind) {
  return Kind == OMPD_task || isOpenMPTaskLoopDirective(Kind);
}

bool c2lang::isOpenMPLoopBoundSharingDirective(OpenMPDirectiveKind Kind) {
...
void c2lang::getOpenMPCaptureRegions(
