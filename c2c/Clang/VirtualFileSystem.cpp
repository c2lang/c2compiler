...
class OverlayFSDirIterImpl : public c2lang::vfs::detail::DirIterImpl {
...
class InMemoryDirIterator : public c2lang::vfs::detail::DirIterImpl {
...
class VFSFromYamlDirIterImpl : public c2lang::vfs::detail::DirIterImpl {
  std::string Dir;
